...
export default function Header() {
  ...
  return (
    <header className="container  fixed  mx-auto bg-theme-bg top-0 px-4  text-sm">
        ...
        >
          ...
          >
            ...
            <video
              ...
              preload="auto"
              playsInline
              className={`h-full w-auto opacity-[${isVisible ? 1 : 0}] `}
              muted
          ...
          <ul className="flex justify-center">
            ...
            >
              ...
              <motion.div
                ...
                initial="hidden"
                animate={`${subnavVisible ? "visible" : "hidden"}`}
                ...
                <div className=" bg-theme-card-hex border-theme-border-05 border-[1px] rounded-sm px-3 py-2 shadow-subnav">
                  <ul className="grid gap-x-[calc(10/16*1rem)] grid-cols-[repeat(2,auto)]">
                    <li className=" min-w-[8rem]">
                      <a href="#" className="subnav_link p-0 py-[.3rem] flex">
                        更新日志
                      </a>
                    </li>
                    ...
                    <li className="min-w-[8rem]">
                      <a
                        ...
                        ref={socityRef}
                        onMouseEnter={() => setIsHoverSocity(true)}
                        onMouseLeave={() => setIsHoverSocity(false)}
                      >
                        论坛
                        <motion.span
                          initial={{ opacity: 0 }}
                          animate={{ opacity: isHoverSocity ? 1 : 0 }}
                        >
                          &nbsp;↗
                        </motion.span>
                      </a>
